...
**注意 : コンテンツ作成時点では CLI v2 の実装が対応中のため、プレビュー版での実装となる点ご了承ください。**
...
## ヒント
 - [機械学習パイプライン ジョブのスケジュールを設定する](https://learn.microsoft.com/azure/machine-learning/how-to-schedule-pipeline-job)
